...
if __name__ == "__main__":
    ...
    message_with_header_footer_and_date = MessageWithDate(
        message_with_header_and_footer
    )
    message_with_header_footer_and_date.print()
    print("-" * 10)

    message_with_header_footer_date_in_base64 = MessageInBase64(
        message_with_header_footer_and_date
    )
